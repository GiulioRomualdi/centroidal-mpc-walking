...
#ifndef CENTROIDAL_MPC_WALKING_SYSTEM_BLOCK_H
#define CENTROIDAL_MPC_WALKING_SYSTEM_BLOCK_H
...
public:
     ...
     */
    virtual bool initialize(std::weak_ptr<BipedalLocomotion::ParametersHandler::IParametersHandler> handler);
...
bool Block<_Derived>::initialize(
...
#endif // CENTROIDAL_MPC_WALKING_SYSTEM_BLOCK_H
